//ICI ON VIENS VERIFIER LE TOKEN ET LE RECUPERER DANS LE HEADER

const jwt = require('jsonwebtoken');

module.exports = (req, res, next) => {
    try {
        //Ici on crée une variable token pour récupéré le header authorization ou va être renseigner notre token
